...
public class View extends JPanel {
    private static final Color BG_COLOR = new Color(0xbbada1); //0xbbada0
    private static final String FONT_NAME = "Arial";
    private static final int TILE_SIZE = 96;
    private static final int TILE_MARGIN = 10; //12
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Score: " + controller.getScore(), 140, 475);  //140-465
